...
<title><?=$_SESSION['isalas_class_id'] ?></title>
<style type="text/css">
iframe
{
position:fixed;
...
<body>
<iframe src="<?=$_SESSION['isalas_attendee_url'] ?>" allowtransparency="yes" wmode="transparent" width="100%" height="620px" frameborder="0" scrolling="no">
