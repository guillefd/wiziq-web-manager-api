...
$config['isalas_system_name'] = 'iSalas';
...
//profile
$config['isalas_url'] = 'demo.isalas.com.ar';
...
$config['isalas_admin_email'] = 'demo@isalas.com.ar';
$config['isalas_admin_pass'] = '12345';
$config['isalas_admin_name'] = 'Demo Admin';

// datos de envio EMAIL
$config['isalas_publisher_email'] = 'info@isalas.com.ar';
$config['isalas_publisher_name'] = 'EyT';
...
$config['isalas_wiziq_presenter_email'] = "info@eytech.com.ar";
$config['isalas_wiziq_return_url'] = "http://demo.isalas.com.ar";
