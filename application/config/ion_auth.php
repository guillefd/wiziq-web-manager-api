...
*/
$config['tables']['users']           = 'ionauth_users';
$config['tables']['groups']          = 'ionauth_groups';
$config['tables']['users_groups']    = 'ionauth_users_groups';
$config['tables']['login_attempts']  = 'ionauth_login_attempts';
